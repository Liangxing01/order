<template>
  <div>
    <header class="the-total">
      <the-price-list class="the-total__left"></the-price-list>
      <the-total-panel
        class="the-total__right"
        :list="totalList"
        :info="totalInfo"
      ></the-total-panel>
    </header>
    ...
    <el-table :data="tableData" style="width: 100%" border>
        ...
        <template v-slot="props">
          <section class="the-card">
            <el-card
              ...
              :key="card.no"
            >
              <the-detail-card :info="card" :list="cardInfo"></the-detail-card>
            </el-card>
          </section>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="120px">
        <span class="the-link" @click="$router.push('/order-detail')">订单详情</span>
      </el-table-column>
    </el-table>
